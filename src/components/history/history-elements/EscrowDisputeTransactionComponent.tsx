...
import {EscrowDispute} from 'src/interfaces/transaction.interface';
...
const EscrowDisputeTransactionComponent = ({
  transaction,
  user,
  locale,
  token = false,
  ...
  const detail = translateEscrowHistoryMessage(
    EscrowHistoryUtils.getEscrowDisputeHistoryMessage(user.name!, transaction),
  );
...
export default EscrowDisputeTransactionComponent;
