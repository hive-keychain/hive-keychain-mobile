...
import {EscrowApprove} from 'src/interfaces/transaction.interface';
...
const EscrowApproveTransactionComponent = ({
  transaction,
  user,
  locale,
  token = false,
  ...
  const detail = translateEscrowHistoryMessage(
    EscrowHistoryUtils.getEscrowApproveHistoryMessage(user.name!, transaction),
  );
...
export default EscrowApproveTransactionComponent;
