...
import {EscrowTransfer} from 'src/interfaces/transaction.interface';
...
const EscrowTransferTransactionComponent = ({
  transaction,
  user,
  locale,
  token = false,
  ...
  const detail = translateEscrowHistoryMessage(
    EscrowHistoryUtils.getEscrowTransferHistoryMessage(user.name!, transaction),
  );
...
export default EscrowTransferTransactionComponent;
